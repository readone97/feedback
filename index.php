...
<html>
  ...
  <body>
    ...
    <h1 class="main-heading">Lecturer Assesing Form</h1>

    <div class="container">
      <h3>
        Fill this student feedback form so that we can make improve our lecturing better.
      </h3>
      ...
      <form action="php/feedback.php" method="post" class="student-form">
        ...
        <div class="student-feedback">
          <!-- Question 1 -->
          <h4>
            1) Has the Lecturer covered entire Syllabus as prescribed by
            University?
          </h4>
          <label>
